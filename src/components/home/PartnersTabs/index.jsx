...
const PartnersTab = () => {
  ...
  return (
    <div className="p-10">
      <ul
        className={`flex border-b rounded-t-lg border-gray-200 bg-gradient-to-r from-[#007A48] to-[#65AF31] py-5 mt-10  items-center justify-center rounded-t-[20px] ${
      ...
      >
        {emojis.map((emoji, index) => (
          <li key={index} className=" mr-1">
            <button
              className={`inline-block mx-2 py-2 px-10 rounded-[10px] text-[20px] bg-[#91BDA4] hover:bg-white ${
