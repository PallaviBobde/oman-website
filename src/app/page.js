...
const DynamicMapComponent = dynamic(() => import("../components/common/MapComponent"));
    ...
    <>
      ...
      >
        <p className="text-lg mb-4 text-gray-700">
          Plant-for-the-Planet is a global movement to restore forest ecosystems
          to tackle the climate crisis and biodiversity loss. To do so, we
          ...
          organizations around the world. We believe that we need to protect the
          world’s three trillion trees and bring back a further one trillion
          trees. Plant-for-the-Planet is a network of independent organisations
